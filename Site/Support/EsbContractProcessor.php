...
abstract class EsbContractProcessor
{

    protected $esbContract;
    protected $templateProcessor;

    public function __construct(EsbContract $esbContract)
    {
        $this->esbContract = $esbContract;
    }
    ...
    public function render()
    {
        ...
        header('Content-Disposition: attachment; filename="' . $this->esbContract->template->file->name . '"');
