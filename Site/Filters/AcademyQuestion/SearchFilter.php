...
namespace ServiceBoiler\Prf\Site\Filters\AcademyQuestion;
...
class SearchFilter extends BaseFilter
{
    ...
    protected $search = 'search_question';
...
//                }
    ...
    {
        return trans('site::academy.plaseholder.search_question');
    }

    protected function columns()
    {
        return [
            'academy_questions.text',
        ];
    }
