...
class RetailSaleReportProductFilter extends WhereFilter
{
    use BootstrapSelect;
    ...
    public function column(): string
    {
        ...
        return 'retail_sale_reports.product_id';
    ...
    public function options(): array
    {
        return Product::where(function ($query) {
            if (auth()->user()->admin == 1) {
                $query->has('retail_sale_reports');
            } else {
                $query->whereHas('retail_sale_reports', function ($query) {
