...
class ProfileEsbRequest extends FormRequest
{
    ...
    public function attributes()
    {
        return [
            ...
            'first_name'                  => trans('site::user.first_name'),
            'last_name'                  => trans('site::user.last_name'),
            'middle_name'                  => trans('site::user.middle_name'),
