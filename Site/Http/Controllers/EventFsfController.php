...
use ServiceBoiler\Prf\Site\Filters\Event\EventFsfFilter;
...
class EventFsfController extends Controller
{
    protected $events;
    private $types;
    ...
    public function index()
    {
        ...
        $this->events->applyFilter(new EventFsfFilter());
        ...
        return view('site::event.index_fsf', [
            ...
            'events'     => $this->events->paginate(config('site.per_page.event', 5), ['events.*'])
        ]);
    }
