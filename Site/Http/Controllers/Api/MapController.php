...
use ServiceBoiler\Prf\Site\Http\Resources\Address\MounterCollection;
...
class MapController extends Controller
{
    ...
    { 
			$accepts = $address->addressable->authorization_accepts()->whereHas('type', function($query){
                        $query->where('brand_id', config('site.brand_default'));
                    })->get();
        return view('site::map.balloon.address',compact('address','accepts'));
    }
