...
class CustomerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('site::admin.customer.index', [
    ...
    {
        $view = $request->ajax() ? 'site::admin.customer.show_modal' : 'site::admin.customer.show';
	...
	public function create(CustomerRequest $request)
    {
        ...
        $roles = CustomerRole::query()->orderBy('title')->get();
         $view = $request->ajax() ? 'site::admin.customer.form_create' : 'site::admin.customer.create';
         return view($view, compact('roles','regions'));
        //return view('site::admin.customer.create', compact('roles','regions'));
    ...
    public function store(CustomerRequest $request)
    {
       ...
       if(!empty($request->input('roles'))) {
        ...
        return redirect()->route('admin.customers.show', $customer)->with('success', trans('site::admin.customer.created'));
    }
    ...
    public function edit(Customer $customer)
    {
        ...
        return view('site::admin.customer.edit', compact('customer','roles','regions'));
    }
    ...
    public function destroy(Customer $customer)
    {
        ...
        if ($customer->delete()) {
            ...
            Session::flash('error', trans('site::admin.customer.error.deleted'));
        }
        $json['redirect'] = route('admin.customers.index');
