...
class StandOrderPaymentEmail extends Mailable implements ShouldQueue
{
    ...
    {
        return $this
            ->subject(trans('site::stand_order.email_payment_title'))
            ->view('site::email.stand_order.payment');
    }
}
