...
@section('content')
    <div class="container">
        ...
        <h1 class="header-title mb-4">@lang('site::user.esb_product_maintenance.new')</h1>
        ...
        @endif
                    <div class="card mb-2">
                        <div class="card-body">
                            ...
                            <form id="form"
                                  method="POST"
                                  action="{{ route('esb-product-maintenances.store') }}">
                                @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3 mr-0">
                                    <div class="form-row mb-2 required">
                                        <label class="control-label w-100"
                                               for="search_serial">@lang('site::user.esb_product_maintenance.serial')</label>
                                            ...
                                            <div class="col-10 mr-0">
                                                <input type="text"
                                                       ...
                                                       value="{{ old('serial',$esbUserProduct ? $esbUserProduct->serial : null) }}"
                                                       placeholder="@lang('site::user.esb_product_maintenance.search_serial')">
                                ...
                                <div class="col-sm-3 ml-0">
                                    ...
                                    <label class="control-label w-100"
                                               for="date">@lang('site::user.esb_product_maintenance.phone')</label>
                                        ...
                                        <div class="col-10 mr-0">
                                            <input type="text"
                                                   ...
                                                   value="{{ old('phone') }}"
                                                   placeholder="@lang('site::user.esb_product_maintenance.search_phone')">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-row mb-2 required">
                                        <label class="control-label"
                                               for="date">@lang('site::user.esb_product_maintenance.date_maintenance')</label>
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <select class="form-control{{  $errors->has('contract_id') ? ' is-invalid' : '' }}"
                                            ...
                                            @foreach($contracts as $contract)
                                                <option
                                                        @if(old('contract_id',$esbUserProduct ? $esbUserProduct->contract_id : null) == $contract->id)
                                                        selected
                                                        @endif
                           ...
                           <h5 id="product_info_header">Информация об оборудовании:</h5>
                            ...
                            <div class="form-row mt-3">
                                <input type="hidden" name="esb_user_product_id" id="esb_user_product_id" value="{{ old('esb_user_product_id',$esbUserProduct ? $esbUserProduct->id : null) }}">
                                    <div class="col mb-3" id="product_info">
                                        
                                   <dl class="row mb-0"> 
                                        <dt class="col-sm-3 text-left text-sm-right">@lang('site::user.esb_user_product.product')</dt>
                                        <dd class="col-sm-9" id="product_info_product">{{$esbUserProduct ? $esbUserProduct->product->name : '' }}</dd>
                                        <dt class="col-sm-3 text-left text-sm-right">@lang('site::user.esb_user_product.serial')</dt>
                                        <dd class="col-sm-9" id="product_info_serial">{{$esbUserProduct ? $esbUserProduct->serial : '' }}</dd>
                                        <dt class="col-sm-3 text-left text-sm-right">@lang('site::user.esb_user_product.address_id')</dt>
                                        <dd class="col-sm-9" id="product_info_address">{{$esbUserProduct ? $esbUserProduct->address_filtred : '' }}</dd>
                                        
                                        <dt class="col-sm-3 text-left text-sm-right">@lang('site::user.esb_product_maintenance.user')</dt>
                                        <dd class="col-sm-9" id="product_info_user_name">{{$esbUserProduct ? $esbUserProduct->user_filtred : '' }}</dd>
                                        <dt class="col-sm-3 text-left text-sm-right">@lang('site::user.esb_user_product.product_second_data')</dt>
                                        <dd class="col-sm-9" id="product_info_second">{{$esbUserProduct ? $esbUserProduct->product_no_cat : '' }}</dd>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-sm-3">
                                    <label class="control-label"
                                               for="number">@lang('site::user.esb_product_maintenance.number')</label>
                                    ...
                                    <input type="text"
                                           ...
                                           value="{{ old('number') }}"
                                           placeholder="@lang('site::user.esb_product_maintenance.number_placeholder')">
                            ...
                            <div class="form-row">
                                <div class="col text-right">
                                    ...
                                    <a href="{{ route('esb-product-maintenances.index') }}" class="btn btn-secondary mb-1">
                            ...
                            if(suggest_count > 1) {
                                ...
                                for(var i in list){
                                   ...
                                   if(prod_data.permission_ok != 1){
                                       ...
                                       $('#product_info_perm').addClass('d-none');
                                   }
