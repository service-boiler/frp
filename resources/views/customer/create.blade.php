...
@section('content')
    <div class="container">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="{{ route('customers.index') }}">@lang('site::admin.customer.index')</a>
            </li>
            <li class="breadcrumb-item active">@lang('site::admin.customer.add')</li>
        </ol>
        @alert()@endalert
            ...
            <div class="card-body">
                    ...
                    <div class="row required">
                        <div class="col-6 required">
                            <label class="control-label"
                                    ...
                                    <input class="mb-0 form-control" type="text" name="search_address" id="search_address" value="" autocomplete="off">
                            ...
                            <input type="hidden" id="locality" name="customer[locality]" value="{{ old('customer.locality') }}">
                        ...
                        <div class="col-6 required">
                                    ...
                                    <select class="mb-0 form-control{{  $errors->has('customer.region_id') ? ' is-invalid' : '' }}"
                                        ...
                                        @foreach($regions as $region)
                                            <option
                                                    @if(old('customer.region_id') == $region->id)
                                                    selected
                                                    @endif
                    ...
                    <div class="form-row">
                                <div class="col mb-1">
                                    ...
                                    <textarea name="customer[any_contacts]"
                                           ...
                                           >{{ old('customer[any_contacts]') }}</textarea>
                                    <span class="invalid-feedback">{{ $errors->first('any_contacts') }}</span>
                                </div>
                    </div>
                    <div class="form-row">
                                <div class="col mb-1">
                ...
                <div class="form-row">
                    <div class="col text-right">
                        ...
                        <a href="{{ route('customers.index') }}" class="btn btn-secondary mb-1">
