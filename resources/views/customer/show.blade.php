...
@section('content')
    <div class="container">
        ...
        <div class="justify-content-start border p-3 mb-2">
            ...
            <a href="{{ route('customers.index') }}" class="d-block d-sm-inline-block btn btn-secondary">
            ...
            <a class="btn btn-primary" href="{{route('customer_contact.create',['customer'=>$customer])}}"><i class="fa fa-plus"></i> Добавить контактное лицо</a>
            ...
            <div class="card mb-2" id="contact-{{$contact->id}}">
                <div class="card-body">
                    <dl class="row mb-1">
                                    ...
                                    <dd class="col-sm-9"><a class="btn btn-primary" href="{{route('customer_contact.edit',['customer'=>$customer, 'contact'=>$contact])}}"><i class="fa fa-pencil"></i>Изменить</a>
                                        ...
                                        <form id="contact-delete-form-{{$contact->id}}"
                                              action="{{route('customer_contact.destroy', ['customer'=>$customer, 'contact'=>$contact])}}"
                                              method="POST">
                                            @csrf
                                            @method('DELETE')
                                        </form> 
