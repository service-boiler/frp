...
@section('content')
    <div class="container">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">@lang('site::admin.customer.contact_add')</li>
        </ol>
        @alert()@endalert
        ...
        <div class="card mb-5">
            <div class="card-body">
                ...
                <form id="form" method="POST" action="{{ route('customer_contact.store',$customer) }}">
                    @csrf
                    <div class="form-row">
                                <div class="col">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox"
                                               @if(old('lpr')) checked @endif
                    ...
                    <div class="form-row">
                                <div class="col mb-1">
                                    ...
                                    <textarea name="contact[any_contacts]"
                                           ...
                                           >{{ old('contact.any_contacts') }}</textarea>
                ...
                <div class="form-row">
                    <div class="col text-right">
                        ...
                        <a href="{{ route('customers.show',$customer) }}" class="btn btn-secondary mb-1">
