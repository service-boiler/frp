             ...
             <div class="event-card__desc-block">
               <header class="event-card__header">
                 ...
                 <div class="tags-block">
					...
					<div class="ya-share2" data-services="vkontakte,facebook,whatsapp,telegram" data-description="{!! $announcement->annotation !!}" data-image="{{Storage::disk($announcement->image->storage)->url($announcement->image->path)}}" data-url="{{route('announcements.index')}}#{{$announcement->id}}" data-title="{{$announcement->title }}"></div>
				   </div>
