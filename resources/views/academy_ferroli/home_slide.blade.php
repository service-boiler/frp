    ...
    <div class="container">  
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="{{ route('home_academy') }}">@lang('site::messages.home')</a>
            </li>
    ...
    <div class="slide-nav">
        <div class="row mt-1 ml-1 mr-1">
            <div class="col-3 text-left text-top">
                @if($slide_num-1>=0)
                    <a href="{{route('home_academy_presentation',$presentation)}}"> 
                        <image style="height: 20px;" src="/images/sl1/stop.png"> 
                    </a>
                     <a href="{{route('home_academy_slide',['presentation'=>$presentation, 'slide_num'=>$slide_num-1])}}">
            ...
            <div class="col-3 text-right text-top">
                @if(!empty($presentation->slides[$slide_num+1]))
                    <a href="{{route('home_academy_slide',['presentation'=>$presentation, 'slide_num'=>$slide_num+1])}}"> <image style="height: 20px;" src="/images/sl1/next.png"> </a>
                @else
                    <a href="{{route('home_academy_presentation',$presentation)}}"> <image data-toggle="tooltip" data-original-title="Выйти из презентации" style="height: 20px;" src="/images/sl1/stop.png"> </a>
                @endif
