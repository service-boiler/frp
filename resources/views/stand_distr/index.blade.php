...
@section('content')
    <div class="container">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">@lang('site::stand_order.orders_distr')</li>
        </ol>
        <h1 class="header-title mb-4"><i class="fa fa-shopping-cart"></i> @lang('site::stand_order.orders_distr')</h1>
            ...
            <div class="card my-4" id="order-{{$standOrder->id}}">
                ...
                <div class="card-header with-elements">
                    <div class="card-header-elements">
                        <a href="{{route('stand-distr.show', $standOrder)}}" class="mr-3">
