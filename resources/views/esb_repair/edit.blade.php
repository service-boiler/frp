        ...
        @endif
                    <div class="card mb-2">
                        <div class="card-body">
                           ...
                           <form id="form"
                              method="POST"
                              action="{{ route('esb-repairs.update',$esbRepair) }}">
                                        ...
                                        <label class="control-label w-100"
                                            ...
                                            <div class="col-10 mr-0">
                                                <input type="text"
                                                       ...
                                                       data-route="serial"
                                                       maxlength="24"
                                                       class="earch_product form-control{{ $errors->has('esb_repair.product_serial') ? ' is-invalid' : '' }}"
                                                       value="{{ old('esb_repair.product_serial',$esbRepair->esbProduct ? $esbRepair->esbProduct->serial : ($esbRepair->product_serial)) }}"
                                                       >
                                    ...
                                    <label class="control-label w-100"
                                        ...
                                        <div class="col-10 mr-0">
                                            <input type="text"
                                                   ...
                                                   value="{{ old('esb_repair.phone',$esbRepair->phone) }}"
                                                  >
                              ...
                              <div class="col-sm-6">
                                    ...
                                    <select class="form-control{{  $errors->has('esb_repair.client_id') ? ' is-invalid' : '' }}"
                                        ...
                                        @foreach($clients as $client)
                                            <option
                                                    @if(old('esb_repair.client_id',$esbRepair->client_id) == $client->id)
                                                    selected
                                                    @endif
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select class="esb_user_product_id form-control{{  $errors->has('esb_repair.esb_user_product_id') ? ' is-invalid' : '' }}"
                                        ...
                                        @foreach($userProducts as $userProduct)
                                            <option
                                                    @if(old('esb_repair.esb_user_product_id',$esbRepair->esb_user_product_id) == $userProduct->id)
                                                    selected
                                                    @endif
                                                    value="{{ $userProduct->id }}">{{ $userProduct->product->name }} SN:{{ $userProduct->serial }} {{ $userProduct->address_filtred }}
                                            </option>
                                        @endforeach
                                    </select>
                                    <span class="invalid-feedback">{{ $errors->first('esb_repair.esb_user_product_id') }}</span>
                                    <input type="hidden" name="esb_repair[product_id]" value="{{old('esb_repair.product_id',$esbRepair->product_id ? $esbRepair->product_id : ($esbRepair->esbUserProduct ? $esbRepair->esbUserProduct->product->id : null))}}" id="repair_product_id">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-6">
                                    ...
                                    <input type="text"
                                           ...
                                           value="{{ old('esb_repair.product_name',$esbRepair->esbProduct ? $esbRepair->esbProduct->product->name  :  $esbRepair->product_name) }}"
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <select class="form-control{{  $errors->has('esb_repair.engineer_id') ? ' is-invalid' : '' }}"
                                        ...
                                        @foreach($engineers as $engineer)
                                            <option
                                                    @if(old('esb_repair.engineer_id',$esbRepair->engineer_id) == $engineer->id)
                                                    selected
                                                    @endif
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <input type="text"
                                           ...
                                           value="{{ old('esb_repair.number',$esbRepair->number) }}"
                                    ...
                                    <div class="form-row mb-2 required">
                                        ...
                                        <div class="input-group date datetimepicker" id="datetimepicker_date_repair"
                                            ...
                                            <input type="text"
                                                   ...
                                                   value="{{ old('esb_repair.date_repair',$esbRepair->date_repair ? $esbRepair->date_repair->format('d.m.Y') : null) }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <input type="number"
                                           ...
                                           class="form-control{{ $errors->has('parts_cost') ? ' is-invalid' : '' }}"
                                           value="{{ old('parts_cost',$esbRepair->parts_cost) }}"
                                          >
                                    ...
                                    <div class="form-group">
                                            ...
                                            <div class="list-group" id="parts"
                                                ...
                                                @foreach($parts as $part) 
                                                    @include('site::part.create_retail', ['product' => $part['product'], 'cost' => $part['cost'], 'count' => $part['count'], 'repair_price_ratio' =>$repair_price_ratio])
                                                @endforeach
                                            </div>
                            ...
                            <div class="form-row required">
                                    ...
                                    <div class="col mb-3">
                                        ...
                                        <textarea
                                              ...
                                              >{{ old('esb_repair.comments', $esbRepair->comments) }}</textarea>
