        ...
        <div class="row">
            <div class="offset-sm-0 col-sm-12 offset-1 col-10">
                ...
                <div class="card mb-2">
                        ...
                        <div class="card-body">
                            <h4 class="card-title mb-1 gray">{{!empty($service->brand_name) ? $service->brand_name : $service->name}} </h4> 
                            
                            <div class="mb-2">
                            @auth()
                                <a class="badge text-normal mb-0 mb-sm-1 badge-primary" href="{{route('user_service_change',$service)}}"><i class="fa fa-check"></i> Выбрать этот сервисный центр</a>
                            @endauth
                            @if($service->hasRole('dealer'))<span class="badge text-normal mb-0 mb-sm-1 badge-ferroli">Официальный дилер</span>@endif
                            @if($service->hasRole('asc'))<span class="badge text-normal mb-0 mb-sm-1 badge-ferroli">Авторизованный сервисный центр</span>@endif
                            </div>
