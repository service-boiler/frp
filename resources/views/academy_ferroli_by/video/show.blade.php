...
@section('content')
    <div class="container">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="{{ route('academy-admin') }}">@lang('site::academy.index')</a>
            </li>
        ...
        @alert()@endalert
         ...
         <div class="justify-content-start border p-3 mb-2">
            ...
            <button type="submit" form="video-delete-form-{{$video->id}}" 
                                @cannot('delete', $video) disabled 
                                data-toggle="tooltip" data-placement="top" data-original-title="@lang('site::admin.video.delete_cannot')"
                                @endcannot
