...
@section('content')
    <div class="container" id="app">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">@lang('site::admin.retail_order.retail_orders')</li>
        </ol>
        <h1 class="header-title mb-4">
            <i class="fa fa-@lang('site::admin.retail_order.icon')"></i> @lang('site::admin.retail_order.retail_orders')
        </h1>
