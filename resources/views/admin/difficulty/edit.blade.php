...
@section('content')
    <div class="container">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">@lang('site::messages.edit') {{$difficulty->name}}</li>
        </ol>
        <h1 class="header-title mb-4">@lang('site::messages.edit') {{$difficulty->name}}</h1>
        @alert()@endalert
                ...
                <div class="card">
                    <div class="card-body">
                        <form method="POST" id="product-type-edit-form"
                              action="{{ route('admin.difficulties.update', $difficulty) }}">
                            ...
                            <div class="form-row required">
                                <div class="col mb-3">
                                    <label class="control-label" for="name">@lang('site::difficulty.name')</label>
                                    <input type="text" name="name"
                                           id="name"
                                           required
                                           class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}"
                                           placeholder="@lang('site::difficulty.placeholder.name')"
                                           value="{{ old('name', $difficulty->name) }}">
                                ...
                                <div class="col mb-3">
                                    ...
                                    <div class="custom-control custom-radio  custom-control-inline">
                                        <input class="custom-control-input
                                               ...
                                               name="active"
                                               required
                                               @if(old('active', $difficulty->active) == 1) checked @endif
                                               id="active_1"
                                               value="1">
                                    ...
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input class="custom-control-input
                                               ...
                                               name="active"
                                               required
                                               @if(old('active', $difficulty->active) == 0) checked @endif
                                               id="active_0"
                                               value="0">
                                        <label class="custom-control-label"
                            ...
                            <div class="form-row required">
                                <div class="col mb-3">
                                    <label class="control-label"
                                           for="contragent_inn">@lang('site::difficulty.cost')</label>
                                    <input type="number"
                                           name="cost"
                                           id="cost"
                                           min="0" step="0.01"
                                           ...
                                           placeholder="@lang('site::difficulty.placeholder.cost')"
                                           value="{{ old('cost', $difficulty->cost) }}">
