...
@section('content')
    <div class="container">
        ...
        <h1 class="header-title mb-4">
            <i class="fa fa-download"></i> @lang('site::messages.load') @lang('site::serial.serials')
        </h1>
        @alert()@endalert()
        <div class="justify-content-start border p-3 mb-2">
            <a class="btn btn-danger d-block d-sm-inline-block"
        ...
        <div class="card mt-2 mb-2">
            <div class="card-body">
                <form enctype="multipart/form-data" action="{{route('admin.serials.store')}}" method="post">
                    @csrf
                    <div class="form-row border p-3">
                        <div class="form-group mb-0">
                            ...
                            <span id="pathHelp" class="d-block form-text text-success">
                                @lang('site::admin.serial_upload_help')
                            </span>
                        </div>
                    </div>
                </form>
