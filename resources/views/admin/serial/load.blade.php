...
<table class="table table-bordered table-responsive table-sm">
    ...
    <tr>
        <td style="width: 4%;"></td>
        <td style="width: 32%;" class="text-center text-dark">A</td>
        <td style="width: 32%;" class="text-center text-dark">B</td>
        <td style="width: 32%;" class="text-center text-dark">C</td>
    </tr>
    </thead>
    <tbody>
