    ...
    <div class="container">
        ...
        <div class=" border p-3 mb-2">
            <a class="btn btn-ms d-block d-sm-inline-block mr-0 mr-sm-1 mb-1 mb-sm-0"
               href="{{ route('admin.mounters.edit', $mounter) }}"
               role="button">
                <i class="fa fa-pencil"></i>
                <span>@lang('site::messages.edit') @lang('site::mounter.mounter')</span>
            </a>
            <a href="{{ route('admin.mounters.index') }}" class="d-block d-sm-inline-block btn btn-secondary">
        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <dl class="row">
                    ...
                    <dt class="col-sm-4 text-left text-sm-right">@lang('site::mounter.header.user_id')</dt>
                    <dd class="col-sm-8">
