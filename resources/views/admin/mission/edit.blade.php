@extends('layouts.app')
@section('title')@lang('site::admin.mission.edit')@lang('site::messages.title_separator')@endsection
@section('content')
<div class="container">
    <ol class="breadcrumb">
...
<form id="form" method="POST" action="{{ route('admin.missions.update', $mission) }}">
@csrf
@method('PUT')
        ...
        <div class="card-body">
                        ...
                        <div class="col">
                            ...
                            <div class="input-group date datetimepicker" id="datetimepicker_date_from"
                                    ...
                                    <input type="text"
                                           ...
                                           value="{{ old('mission.date_from',$mission->date_from->format('d.m.Y')) }}">
                        ...
                        <div class="col">
                            ...
                            <div class="input-group date datetimepicker" id="datetimepicker_date_to"
                                    ...
                                    <input type="text"
                                           ...
                                           value="{{ old('mission.date_to',$mission->date_to->format('d.m.Y')) }}">
                                    <div class="input-group-append"
                                         data-target="#datetimepicker_date_to"
                                         data-toggle="datetimepicker">
                                        <div class="input-group-text">
            ...
            <div class="row required">        
                <div class="col-6 required">
                    <label class="control-label"
                            ...
                            <input class="form-control" type="text" name="search_address" id="search_address" value="{{ old('mission.locality',$mission->locality) }}" autocomplete="off">
                ...
                <div class="col-6 required">
                            ...
                            <select class="form-control{{  $errors->has('mission.region_id') ? ' is-invalid' : '' }}"
                                ...
                                @foreach($regions as $region)
                                    <option
                                            @if(old('mission.region_id',$mission->region_id) == $region->id)
                                            selected
                                            @endif
             ...
             <input type="hidden" id="locality" name="mission[locality]" value="{{ old('mission.locality',$mission->locality) }}">
            ...
            <div class="form-row">
                        <div class="col mb-3">
                            ...
                            <textarea
                                  ...
                                  >{{ old('mission.target',$mission->target) }}</textarea>
            ...
            <div class="row">        
                ...
                <div class="col-4">
                            ...
                            <select class="form-control{{  $errors->has('mission.division_id') ? ' is-invalid' : '' }}"
                                ...
                                @foreach($divisions as $division)
                                    <option
                                            @if(old('mission.division_id',$mission->division_id) == $division->id)
                                            selected
                                            @endif
                ...
                <div class="col-4">
                            ...
                            <select class="form-control{{  $errors->has('mission.project_id') ? ' is-invalid' : '' }}"
                                ...
                                @foreach($projects as $project)
                                    <option
                                            @if(old('mission.project_id',$mission->project_id) == $project->id)
                                            selected
                                            @endif
                ...
                <div class="col-2">
                            ...
                            <input class="form-control" type="number" name="mission[budget]" value="{{old('mission.budget',$mission->budget)}}" >
                ...
                <div class="col-2">
                            ...
                            <select class="form-control{{  $errors->has('mission.budget_currency_id') ? ' is-invalid' : '' }}"
                                ...
                                <option value="643"  @if(old('mission.budget_currency_id',$mission->budget_currency_id) != 978) selected @endif>RUB</option>
                               
                                    <option @if(old('mission.budget_currency_id',$mission->budget_currency_id) == 978) selected @endif value="978">EUR</option>
            ...
            <div class="form-row">
                        <div class="col mb-3">
                            ...
                            <textarea
                                  ...
                                  >{{ old('mission.comments',$mission->comments) }}</textarea>
                           ...
                           <div class="col-sm-5">
                            ...
                            <div class="col-sm-7">
                                <div class="form-group">  
                                    ...
                                    @include('site::admin.mission.create_user', ['user' => $user, 'main' => $user->pivot->main])
                                    @endforeach
                                    </div>
                                </div>
                            </div>
