@extends('layouts.app')
@section('title')Заказ на витрину. Новый {{$user->name}}@endsection
@section('content')
    <div class="container">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Новый заказ на витрину {{$user->name}}</li>
        </ol>
    ...
    <form id="form"
                      ...
                      action="{{ route('admin.stand-orders.store') }}">
                      @csrf
                      <input type="hidden" name="standOrder[status_id]" value="1">
                      <input type="hidden" name="standOrder[user_id]" value="{{$user->id}}">
                      
        <div class="card-body">
            <div class="row">
             
                <div class="col">
                <h5>Дилер: {{$user->name}}</h5>
                </div>
            </div>
