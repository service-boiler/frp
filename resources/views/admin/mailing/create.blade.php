        ...
        <div class="card mb-2">
            <div class="card-body text-muted" id="summernote">
                <form id="form-content"
                    ...
                    @if(!empty($link))
                    <div class="row">
                        <div class="col mb-3"> <span class="text-danger">Внимание! Скопируйте эту ссылку на событие в нужное место письма!</span> <br />
                        <a href="{{$link}}"><span class="text-success">{{$link}}</span></a>
                        </div>
                    </div>
                    @endif
                    <div class="form-row required">
