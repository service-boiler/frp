            ...
            <div class="card my-4" id="tender-{{$tender->id}}">
                ...
                <div class="card-header with-elements">
                    ...
                    <div class="card-header-elements">
                        <a href="{{route('admin.tenders.show', $tender)}}" class="mr-3 text-big">
                        ...
                        <span class="badge text-normal badge-pill text-white" style="background-color: {{ $tender->status->color }}">
                            <i class="fa fa-{{ $tender->status->icon }}"></i> {{ $tender->status->name }}
                        </span>
                    ...
                    <div class="card-header-elements ml-md-auto">
                        ...
                        <a href="{{route('admin.users.show', $tender->user)}}">
                            @if($tender->user->image->fileExists)
                                <img id="user-logo" src="{{$tender->user->logo}}"
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-sm-6">
                        <dl class="dl-horizontal mt-2">
                            ...
                            <dd class="col-12"><a href="{{route('admin.users.show',$tender->distributor)}}" target="_blank">{{$tender->distributor->name }}</a></dd>
