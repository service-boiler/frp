                            ...
                            <div class="form-row required">
                                <div class="col">
                                    ...
                                    <input type="text"
                                           ...
                                           required
                                           value="{{ old('customers.' .$field_name .'.' .$row_num .'.customer.name') }}">
                                ...
                                <input type="hidden" id="{{$field_name}}-{{$row_num}}_customer_id" name="customers[{{$field_name}}][{{$row_num}}][customer][id]" 
                                    value="{{ old('customers.' .$field_name .'.' .$row_num .'.customer.id') }}">
                            ...
                            <div class="form-row d-none">
                                    ...
                                    <div class="col-4">
                                        <label class="control-label"
                                                ...
                                                value="{{ old('customers.' .$field_name .'.' .$row_num .'.customer.locality') }}" autocomplete="off"
                                        ...
                                        <input type="hidden" id="{{$field_name}}-{{$row_num}}_locality" name="customers[{{$field_name}}][{{$row_num}}][customer][locality]" value="{{ old('customers.' .$field_name .'.' .$row_num .'.customer.locality') }}">
                                        <input type="hidden" id="{{$field_name}}-{{$row_num}}_region_id" name="customers[{{$field_name}}][{{$row_num}}][customer][region_id]" value="{{ old('customers.' .$field_name .'.' .$row_num .'.customer.region_id') }}">
                                    ...
                                    <div class="col-4">
                                            ...
                                            <input 
                                                   ...
                                                   value="{{ old('customers.' .$field_name .'.'.$row_num .'.customer.phone') }}">
                                     ...
                                     <div class="col-4">
                                            ...
                                            <input type="text" name="customers[{{$field_name}}][{{$row_num}}][customer][email]"
                                                   ...
                                                   value="{{ old('customers.' .$field_name .'.'.$row_num .'.customer.email') }}">
                                     ...
                                     <div class="col-3">
                                            ...
                                            <input type="text" name="customers[{{$field_name}}][{{$row_num}}][contact][name]"
                                                   ...
                                                   class="customer-contact-name form-control{{ $errors->has('customers.' .$field_name .'.' .$row_num .'.contact.name') ? ' is-invalid' : '' }}"
                                                    value="{{ old('customers.' .$field_name .'.'.$row_num .'.contact.name') }}"
                                                   >
                                            <span class="invalid-feedback">{{ $errors->first('customers.' .$field_name .'.' .$row_num .'.contact.name') }}</span>
                                    </div>
                                    
                                    <input type="hidden" id="{{$field_name}}-{{$row_num}}_contact_id" name="customers[{{$field_name}}][{{$row_num}}][contact][id]" value="{{ old('customers .' .$field_name .'.' .$row_num .'.contact.id') }}">
                                     ...
                                     <div class="col-3">
                                            ...
                                            <input type="text" name="customers[{{$field_name}}][{{$row_num}}][contact][position]"
                                                   ...
                                                   class="form-control{{ $errors->has('customers.' .$field_name .'.' .$row_num .'.contact.position') ? ' is-invalid' : '' }}"
                                                    value="{{ old('customers.' .$field_name .'.' .$row_num .'.contact.position') }}"
                                                   >
                                    </div>
                                    ...
                                    <div class="col-3">
                                            ...
                                            <input 
                                                   ...
                                                   value="{{ old('customers.' .$field_name .'.' .$row_num .'.contact.phone') }}">
                                    </div>
                                     <div class="col-3">
                                            ...
                                            <input type="text" name="customers[{{$field_name}}][{{$row_num}}][contact][email]"
                                                   ...
                                                   value="{{ old('customers.' .$field_name .'.' .$row_num .'.contact.email') }}">
                                    </div>
                                     <div class="col-3">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       @if(old('customers.' .$field_name .'.' .$row_num .'.contact.lpr')) checked @endif
                                     ...
                                     <div class="col-3">
                                            <a href="javascript:void(0);" class="store-field" data-field-name="{{$field_name}}" data-form-id="{{$field_name}}-{{$row_num}}">Сохранить анкету</a>
                                    </div>
