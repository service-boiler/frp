...
@section('content')
    <div class="container">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="{{ route('admin.tenders.show',$tender) }}">Тендерная заявка № {{$tender->id}} ({{$tender->distributor->name}})</a>
            </li>
        ...
        <div class=" border p-3 mb-2">
            ...
            <a href="{{ route('admin.tenders.show',$tender) }}" class="btn btn-secondary">
