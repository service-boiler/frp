@extends('layouts.app')
@section('title')@lang('site::admin.revision_part.add')@lang('site::messages.title_separator')@endsection
@section('content')
<div class="container">
    <ol class="breadcrumb">
...
<form id="form" method="POST" action="{{ route('admin.revision_parts.store') }}">
@csrf
    <div class="card mb-5">
        <div class="card-body">
                    ...
                    <div class="form-row">
                        <div class="col">
                            ...
                            <input type="text"
                                   ...
                                   value="{{ old('revisionPart.part_old_sku') }}">
                    ...
                    <div class="form-row">
                        <div class="col">
                            ...
                            <input type="text"
                                   ...
                                   value="{{ old('revisionPart.part_old_name') }}">
                    ...
                    <div class="form-row required">
                        <div class="col">
                            ...
                            <input type="text" required
                                   ...
                                   value="{{ old('revisionPart.part_new_sku') }}">
                    ...
                    <div class="form-row">
                        <div class="col">
                            ...
                            <input type="text"
                                   ...
                                   value="{{ old('revisionPart.part_new_name') }}">
                            <span class="invalid-feedback">{{ $errors->first('revisionPart.part_new_id') }}</span>
                        </div>
                    </div>
                
                </div>
                  <input type="hidden" id="part_old_id" name="revisionPart[part_old_id]" value="{{ old('revisionPart.part_old_id') }}">
                  <input type="hidden" id="part_new_id" name="revisionPart[part_new_id]" value="{{ old('revisionPart.part_new_id') }}">
                        ...
                        <div class="col">
                            ...
                            <div class="input-group date datetimepicker" id="datetimepicker_date_change"
                                    ...
                                    <input type="text"
                                           ...
                                           value="{{ old('revisionPart.date_change') }}">
                        ...
                        <div class="col">
                            ...
                            <div class="input-group date datetimepicker" id="datetimepicker_date_notice"
                                    ...
                                    <input type="text"
                                           ...
                                           value="{{ old('revisionPart.date_notice') }}">
                                    <div class="input-group-append"
                                         data-target="#datetimepicker_date_notice"
                                         data-toggle="datetimepicker">
                                        <div class="input-group-text">
                    ...
                    <div class="form-row">
                        <div class="col">
                            <div class="custom-control custom-checkbox mt-4 ml-3">
                                <input type="checkbox"
                                       @if(old('revisionPart.interchange')) checked
                                       @endif
                ...
                <div class="col-md-1">
                    <div class="form-row">
                        <div class="col">
                            <div class="custom-control custom-checkbox mt-4 ml-3">
                                <input type="checkbox"
                                       @if(old('revisionPart.enabled')) checked
                                       @endif
                ...
                <div class="col-md-3">
                    <div class="form-row ml-4">
                        <div class="col">
                            <div class="custom-control custom-checkbox mt-4 ml-3">
                                <input type="checkbox"
                                       @if(old('revisionPart.public')) checked
                                       @endif
            ...
            <div class="form-row">
                        <div class="col mb-3">
                            ...
                            <textarea
                                  ...
                                  >{{ old('revisionPart.text_object') }}</textarea>
            ...
            <div class="form-row">
                        <div class="col mb-3">
                            ...
                            <textarea
                                  ...
                                  >{{ old('revisionPart.description') }}</textarea>
            ...
            <div class="form-row">
                        <div class="col mb-3">
                            ...
                            <textarea
                                  ...
                                  >{{ old('revisionPart.comments') }}</textarea>
