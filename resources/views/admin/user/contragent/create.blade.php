...
@section('content')
    <div class="container">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="{{ route('admin.users.contragents.index', $user) }}">@lang('site::contragent.contragents')</a>
            </li>
            <li class="breadcrumb-item active">@lang('site::messages.add') @lang('site::contragent.contragent')</li>
        </ol>
        ...
        <div class="card mt-2 mb-2">
            <div class="card-body">
                ...
                <form id="contragent-form" method="POST" action="{{ route('admin.users.contragents.store',$user) }}">
                    @csrf
                    <input type="hidden" name="contragent[user_id]" value="{{$user->id}}">
                    <div class="row">
                        <div class="col-md-6">
