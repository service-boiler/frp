...
@section('content')
    <div class="container">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="{{ route('admin.engineers.show', $user) }}">{{ $user->name }}</a>
            </li>
        ...
        <div class="row justify-content-center my-4">
            <div class="col-md-12">
                <form id="user-form" method="POST"
                      action="{{ route('admin.engineers.update', $user) }}">
                            ...
                            <div class="form-row required">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <input type="tel"
                                           ...
                                           value="{{ old('user.phone',$user->phone) }}">
                                ...
                                <div class="col-sm-6 mb-3">
                                    ...
                                    <select class="form-control
                                        ...
                                        @foreach($regions as $region)
                                            <option   @if(old('user.region_id', $user->region_id) == $region->id)
                                                            selected
                                                            @endif
                                ...
                                <div class="col-sm-6 mb-3">
                                    ...
                                    <select class="form-control
                                        ...
                                        @foreach($userTypes as $userType)
                                            <option   @if(old('user.type_id', $user->type_id) == $userType->id)
                                                      selected
                                                      @endif
