...
@section('content')
    <div class="container">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="{{ route('admin.esb-maintenance-product-groups.index') }}">@lang('site::product.difficulties')</a>
            </li>
                ...
                <div class="card">
                    <div class="card-body">
                        <form method="POST" id="create-form"
                              action="{{ route('admin.esb-maintenance-product-groups.store') }}">
