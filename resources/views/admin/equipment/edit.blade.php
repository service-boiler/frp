                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-row">
                                <div class="col">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox"
                                               @if(old('equipment.show_market_ru', $equipment->show_market_ru)) checked @endif
                    ...
                    <div class="form-row">
                        <div class="col">
                            ...
                            <input type="text"
                                   ...
                                   placeholder="@lang('site::equipment.placeholder.annotation')"
                                   value="{{ old('equipment.annotation_by', $equipment->annotation_by) }}">
                            <span class="invalid-feedback">{{ $errors->first('equipment.annotation_by') }}</span>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col">
                            <label class="control-label" for="menu_annotation">@lang('site::equipment.menu_annotation')</label>
                            <input type="text"
                                   name="equipment[menu_annotation]"
                                   id="annotation"
                                   class="form-control{{ $errors->has('equipment.menu_annotation') ? ' is-invalid' : '' }}"
                                   placeholder="@lang('site::equipment.placeholder.annotation')"
                                   value="{{ old('equipment.menu_annotation', $equipment->menu_annotation) }}">
                            <span class="invalid-feedback">{{ $errors->first('equipment.menu_annotation') }}</span>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col">
