...
@section('content')
    <div class="container">
        ...
        <h1 class="header-title mb-4">@lang('site::messages.edit') {{$template_file->name}}</h1>
        @alert()@endalert
                ...
                <div class="card">
                    <div class="card-body">
                        <form method="POST" id="form"
                              action="{{ route('admin.template-files.update', $template_file) }}">
                            ...
                            <div class="form-row required mt-3">
                                <div class="col">
                                    ...
                                    <input required
                                           ...
                                           placeholder="@lang('site::admin.template_file.placeholder.name')"
                                           value="{{ old('template_file.name', $template_file->name) }}">
                        ...
                        <div class=" text-right">
                            ...
                            <a href="{{ route('admin.template-files.show', $template_file) }}"
