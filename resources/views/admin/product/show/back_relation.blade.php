<li class="list-group-item" id="product-back-relation-{{$relation->id}}">
            ...
            <div class="row">
                ...
                <div class="col-2">
                    <a class="pull-right btn btn-sm btn-light btn-row-delete"
                       data-form="#product-back-relation-delete-form-{{$relation->id}}"
                       data-btn-delete="@lang('site::messages.delete')"
                       data-btn-cancel="@lang('site::messages.cancel')"
                       data-label="@lang('site::messages.delete_confirm')"
                       data-message="@lang('site::messages.delete_sure') @lang('site::relation.header.back_relation') {{ $relation->name() }}?"
                       data-toggle="modal" data-target="#form-modal"
                       href="javascript:void(0);"
                       title="@lang('site::messages.delete')"><i class="fa fa-close"></i></a>
                    <form id="product-back-relation-delete-form-{{$relation->id}}"
