...
@section('content')
    <div class="container">
        ...
        <div class=" border p-3 mt-2 mb-4">
            ...
            {{--</a>--}}
            <button name="_stay" form="product-edit-form" value="1" type="submit" class="btn btn-ms">
                <i class="fa fa-check"></i>
                <span>@lang('site::messages.save_stay')</span>
            </button>
            <button name="_stay" form="product-edit-form" value="0" type="submit" class="btn btn-ms">
                <i class="fa fa-check"></i>
