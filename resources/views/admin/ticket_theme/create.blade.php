...
@section('content')
    <div class="container">
        ...
        <h1 class="header-title mb-4">@lang('site::messages.add') @lang('site::ticket.theme.ticket_theme_add')</h1>
        ...
        <div class="card mb-5">
            <div class="card-body">
                ...
                <form id="form" method="POST" action="{{ route('admin.ticket-themes.store') }}">
                    @csrf
                    <div class="form-row">
                                <div class="col mb-3">
                    ...
                    <div class="form-row">
                                <div class="col mb-3">
                                    ...
                                    <input type="text" name="ticketTheme[name_feedback]"
                                           ...
                                           placeholder="@lang('site::admin.placeholder.name_feedback')">
                            ...
                            <div class="form-group">
                                ...
                                <select id="list_receiver_id"
                                    ...
                                    @foreach($users as $user)
                                        <option @if(old('ticketTheme.default_receiver_id') == $user->id)
                                                selected
                                                @endif
                                                value="{{$user->id}}">
                                            {{$user->name}}
                        ...
                        <div class="col">
                            <label class="control-label" for="default_text">@lang('site::ticket.text')(Шаблон)</label>
                                <textarea 
                                      ...
                                      >{{ old('ticketTheme.default_text') }}</textarea>
                            ...
                            <div class="form-row">
                                <div class="col">
                                    <div class="custom-control custom-checkbox mt-4 ml-3">
                                        <input type="checkbox"
                                               @if(old('ticketTheme.for_feedback')) checked
                                               @endif
                        ...
                        <div class="col-md-3">
                            <div class="form-row">
                                <div class="col">
                                    <div class="custom-control custom-checkbox mt-4 ml-3">
                                        <input type="checkbox"
                                               @if(old('ticketTheme.for_manager')) checked
                                               @endif
