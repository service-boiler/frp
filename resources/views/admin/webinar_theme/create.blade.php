...
@section('content')
    <div class="container">
        ...
        <h1 class="header-title mb-4">@lang('site::messages.add') @lang('site::admin.webinar_theme.webinar_theme_add')</h1>
        ...
        <div class="card mb-5">
            <div class="card-body">
                ...
                <form id="form" method="POST" action="{{ route('admin.webinar-themes.store') }}">
                    @csrf
                    <div class="form-row">
                                <div class="col mb-3">
