    ...
    <div class="container" id="app">
        ...
        <div class="card mb-5">
            <div class="card-body">
                ...
                <form id="form" method="POST" action="{{ route('ferroli-user.user_prereg.update',$prereg) }}">
                    @csrf
                    @method('PUT')
                    <div class="form-row required mt-3">
                        <div class="col-3">
                            ...
                            <input type="text"
                                   ...
                                   value="{{ old('prereg.lastname' ,$prereg->lastname) }}">
                        ...
                        <div class="col-3">
                            ...
                            <input type="text"
                                   ...
                                   value="{{ old('prereg.firstname' ,$prereg->firstname) }}">
                        ...
                        <div class="col-3">
                            ...
                            <input type="text"
                                   ...
                                   value="{{ old('prereg.middlename' ,$prereg->middlename) }}">
                        ...
                        <div class="col-3 required">
                                    ...
                                    <select class="form-control{{  $errors->has('prereg.role_id') ? ' is-invalid' : '' }}"
                                            ...
                                            required
                                            id="role_id">
                                            <option @if($prereg->role_id==14) selected @endif value="14">Монтажник ФЛ </option>
                                            <option @if($prereg->role_id==15) selected @endif value="15">Сервис ФЛ </option>
                                            <option @if($prereg->role_id==16) selected @endif value="16">Продавец ФЛ </option>
                    ...
                    <div class="form-row mt-3">
                        <div class="col-3 required">
                            ...
                            <input type="email"
                                   ...
                                   id="email"
                                   required
                                   class="form-control{{ $errors->has('user_preregs.email') ? ' is-invalid' : '' }}"
                                   value="{{ old('prereg.email' ,$prereg->email) }}">
                            <span class="invalid-feedback">{{ $errors->first('user_preregs.email') }}</span>
                        </div>
                        <div class="col-3">
                            ...
                            <input type="tel"
                                   ...
                                   value="{{ old('prereg.phone' ,$prereg->phone) }}">
                            <span class="invalid-feedback">{{ $errors->first('prereg.phone') }}</span>
                        </div>
                        <div class="col-6 ">
                            <label class="control-label"
                                               for="users_search">Компания</span></label>
                                    <input class="form-control" type="text" name="users_search" id="users_search" value="@if($prereg->parentUser){{$prereg->parentUser->name}}@endif" autocomplete="off">
                    ...
                    <div class="row required">        
                        <div class="col-6 required">
                            <label class="control-label"
                                    ...
                                    <input class="form-control" type="text" name="search_address" id="search_address" value="{{$prereg->locality}}" autocomplete="off">
                        ...
                        <div class="col-6 required">
                                    ...
                                    <select class="form-control{{  $errors->has('prereg.region_id') ? ' is-invalid' : '' }}"
                                        ...
                                        @foreach($regions as $region)
                                            <option
                                                    @if(old('prereg.region_id' ,$prereg->region_id) == $region->id)
                                                    selected
                                                    @endif
                     ...
                     <input type="hidden" id="locality" name="prereg[locality]" value="{{ old('prereg.locality' ,$prereg->locality) }}">
                     <input type="hidden" id="parent_user_id" name="prereg[parent_user_id]" value="{{ old('prereg.parent_user_id' ,$prereg->parent_user_id) }}">
                     
                </form>
                <hr/>
                <form id="prereg-delete-form-{{$prereg->id}}"
                      action="{{route('ferroli-user.user_prereg.destroy', $prereg)}}"
                      method="POST">
                    @csrf
                    @method('DELETE')
                    </form>
                ...
                <div class="form-row">
                    <div class="col text-right">
                        ...
                        <button class="pull-right btn btn-danger ml-4 btn-row-delete"
                                        data-form="#prereg-delete-form-{{$prereg->id}}"
                                        data-btn-delete="@lang('site::messages.delete')"
                                        data-btn-cancel="@lang('site::messages.cancel')"
                                        data-label="@lang('site::messages.delete_confirm')"
                                        data-message="@lang('site::messages.delete_sure') предрегистрацию? "
