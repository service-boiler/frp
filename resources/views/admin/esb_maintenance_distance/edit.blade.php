...
@section('content')
    <div class="container">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">@lang('site::messages.edit') {{$esbMaintenanceDistance->name}}</li>
        </ol>
        <h1 class="header-title mb-4">@lang('site::messages.edit') {{$esbMaintenanceDistance->name}}</h1>
        @alert()@endalert
                ...
                <div class="card">
                    <div class="card-body">
                        <form method="POST" id="edit-form"
                              action="{{ route('admin.esb-maintenance-distances.update', $esbMaintenanceDistance) }}">
                            ...
                            <div class="form-row required">
                                <div class="col mb-3">
                                    ...
                                    <input type="text" name="name"
                                           ...
                                           value="{{ old('name', $esbMaintenanceDistance->name) }}">
                                ...
                                <div class="col mb-3">
                                    ...
                                    <div class="custom-control custom-radio  custom-control-inline">
                                        <input class="custom-control-input
                                               ...
                                               name="active"
                                               required
                                               @if(old('active', $esbMaintenanceDistance->active) == 1) checked @endif
                                               id="active_1"
                                               value="1">
                                    ...
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input class="custom-control-input
                                               ...
                                               name="active"
                                               required
                                               @if(old('active', $esbMaintenanceDistance->active) == 0) checked @endif
                                               id="active_0"
                                               value="0">
                                        <label class="custom-control-label"
                            ...
                            <div class="form-row required">
                                <div class="col-4 mb-3">
                                    ...
                                    <input type="number"
                                           ...
                                           value="{{ old('cost', $esbMaintenanceDistance->cost) }}">
