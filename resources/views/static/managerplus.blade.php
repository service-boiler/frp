...
<section class="masterplus">
     ...
     <div class="title-block title-block--gray"  style="padding: 30px;">
        <div class="container">
          <h1>2 УРОВНЯ БОНУСНОЙ ПРОГРАММЫ  <span class="rng">«МЕНЕДЖЕР+»</span></h1>
        </div>
     </div>
     ...
     <div class="container">
       ...
       <ul class="list part-step-list">
         ...
         <li>
           <span class="part-step-list__step">Продажи</span>
           <p class="part-step-list__desc">Продавайте котлы Ferroli и сообщайте нам <br />(отчет о продаже формируется в Вашем личном кабинете)</p>
         </li>
       ...
       <div class="btn-block"><a href="{{route('register_fls')}}" class="btn block-btn">Стать участником</a></div>
  
       <div class="img-block pos-img masterplus__bg-img"><img src="images/manager-plus-bg.png" alt="master-plus"></div>
     </div>
   ...
   <section class="advantages">
     <div class="title-block title-block--gray">
        <div class="container">
          ...
          <div class="img-block"><img src="/images/logo_manager_plus.png" alt="master-plus" style="max-height: 100px;"></div>
        </div>
     </div>
         ...
         <div class="row justify-content-center">
           <div class="card-col">
             <div class="card advant-card">
               ...
               <p>
                 Увеличение дохода за продажу оборудования Ferroli.
  ...
  <div class="site-form js-siteForm">
    ...
    <div class="site-form-wrapper">
      <div class="row">
        ...
        <div class="desc"><a href="{{route('register_fls')}}">Присоединяйся и зарабатывай с Ferroli</a></div>
