@extends('layouts.app')
@section('title')@lang('site::tender.tenders') @lang('site::messages.create')@lang('site::messages.title_separator')@endsection
@section('content')
    <div class="container">
        <ol class="breadcrumb">
                ...
                <form id="form"
                    ...
                    <div class="card mt-2 mb-2">
                        <div class="card-body">
                            ...
                            <input type="hidden" name="tender[distributor_id]" value="{{auth()->user()->company()->id}}">

                            <div class="row">
                                <div class="col">
                                    <label class="control-label" for="distr_contragent_id">Плательщик (юр.лицо)</label>
                                    <select
                                    id="distr_contragent_id"
                                    class="form-control"
                                    name="tender[distr_contragent_id]">
                                @foreach(auth()->user()->company()->contragents as $contragent)
                                    <option @if(old('tender.distr_contragent_id') == $contragent->id) selected
                                            @endif
                                            value="{{$contragent->id}}">
                                        {{$contragent->name}}
                                    </option>
                            ...
                            <div class="form-group required ">
                                ...
                                <div class="input-group">
                                    <input required
                                           ...
                                           value="{{ old('tender.distr_contact_phone',auth()->user()->phone) }}"
                                           >
                                    <div class="input-group-append">
                                        <div class="input-group-text">
                            ...
                            <div class="form-row required">
                                <div class="col">
                                    ...
                                    <input type="text"
                                           ...
                                           value="{{ old('tender.distr_contact',auth()->user()->name) }}">
                    ...
                    <div class="form-row">   
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="hidden" name="tender[source_id]" value="2">
