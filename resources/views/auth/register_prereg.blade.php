        ...
        <div class="row pt-5 pb-5">
            <div class="col">
                <form id="register-form" method="POST" action="{{ route('register_fl') }}">
                    ...
                    <div class="form-row required">
						...
						<input type="hidden" name="contact[type_id]" value="1">
						    <input type="text"
                                   ...
                                   value="{{ old('name', $user_prereg->lastname .' ' .$user_prereg->firstname .' ' .$user_prereg->middlename) }}">
                            ...
                            <div class="form-row required">
                                <div class="col">
                                    ...
                                    <input required
                                           ...
                                           value="{{ old('phone.contact.number',$user_prereg->phone) }}">
                            ...
                            <div class="form-row required">
                                    ...
                                    <div class="col required">
                                        ...
                                        <select class="form-control{{  $errors->has('address.sc.region_id') ? ' is-invalid' : '' }}"
                                            ...
                                            @foreach($address_sc_regions as $region)
                                                <option
                                                        @if(old('address.sc.region_id',$user_prereg->region_id) == $region->id) selected
                                                        @endif
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text"
                                               ...
                                               value="{{ old('address.sc.locality',$user_prereg->locality) }}">
                                            ...
                                            <div class="custom-control custom-radio custom-control">
                                                <input class="custom-control-input
                                                    {{$errors->has('contact.role') ? ' is-invalid' : ''}}"
                                                       ...
                                                       name="contact[role]"
                                                       required
                                                       @if(old('contact.role',$user_prereg->role_id) == 16) checked
                                                       @endif
                                                       id="role_16"
                                                       value="16">
                                                <label class="custom-control-label"
                                                       for="role_16">@lang('site::user.roles.sale')</label>
                                            </div>
                                            <div class="custom-control custom-radio custom-control">
                                                <input class="custom-control-input
                                                    {{$errors->has('contact.role') ? ' is-invalid' : ''}}"
                                                       ...
                                                       name="contact[role]"
                                                       required
                                                       @if(old('contact.role',$user_prereg->role_id) == 15) checked
                                                       @endif
                                                       id="role_15"
                                                       value="15">
                                                <label class="custom-control-label"
                                            ...
                                            <div class="custom-control custom-radio custom-control">
                                                <input class="custom-control-input
                                                    {{$errors->has('contact.role') ? ' is-invalid' : ''}}"
                                                       ...
                                                       name="contact[role]"
                                                       required
                                                       @if(old('contact.role',$user_prereg->role_id) == 14) checked
                                                       @endif
                                                       id="role_14"
                                                       value="14">
                                                <label class="custom-control-label"
                    ...
                    <input type="hidden" name="prereg_id" value="{{$user_prereg->id}}">
                    <div class="form-row text-center mt-5 mb-3">
        ...
        window.addEventListener('load', function () {
            ...
            users_search.on('select2:select', function (e) {
                ...
                if (!selected.includes(id)) {
                    ...
                    selected.push(id);
                     document.getElementById('parent_user').remove();
