...
@section('content')
    <div class="container">
        ...
        <div class="card mt-2 mb-2">
            <div class="card-body">
                <form id="form" method="POST" action="{{ route('contragents.addresses.update', [$contragent, $address]) }}">
                    @csrf
                    @method('PUT')
					...
					<div class="form-row required">
                        <div class="col mb-3">
                            <label class="control-label"
                                   for="address_locality">@lang('site::address.postal')</label>
                            <input type="text"
                                   name="address[postal]"
                                   id="address_postal"
                                   required
                            ...
                            <span class="invalid-feedback">{{ $errors->first('address.postal') }}</span>
                        </div>
                    </div>
                    <div class="form-row required">
                        <div class="col mb-3">
