...
@section('content')
    <div class="container">
        ...
        <div class="card mb-5">
            <div class="card-body">
                <form id="form" method="POST" action="{{ route('esb-contract-templates.store') }}">
                    @csrf
                    ...
                    <div class="form-row">
                        <div class="col-6">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox"
                                       @if(old('esb_contract_template.enabled')) checked @endif
                    ...
                    @if(auth()->user()->hasPermission('admin_esb_super') || auth()->user()->admin)
                        <div class="col-6">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox"
                                       @if(old('esb_contract_template.shared')) checked @endif
                    ...
                    <div class="form-row required mt-3">
                        <div class="col">
                            ...
                            <input type="text"
                                   ...
                                   value="{{ old('esb_contract_template.name') }}">
                    ...
                    <div class="form-row required mt-3">
                        <div class="col">
                            ...
                            <input type="text"
                                   ...
                                   value="{{ old('esb_contract_template.prefix') }}">
