        ...
        <div class="card mb-5">
            <div class="card-body">
                    ...
                    <dd class="col-sm-9">@foreach($stage->tests as $test)
                                          ...
                                          @endforeach</dd>
                    <dt class="col-sm-3 text-left text-sm-right mb-3">@lang('site::academy.stage.parent_stage'):</dt>
                    <dd class="col-sm-9">@if(!empty($stage->parentStage)){{$stage->parentStage->name}}@endif</dd>
