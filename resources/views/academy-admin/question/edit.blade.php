...
@section('content')
    <div class="container">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">@lang('site::messages.edit')  @lang('site::academy.question.add')</li>
        </ol>
        @alert()@endalert
        ...
        <div class="card mb-5">
            <div class="card-body">
                ...
                <form id="form" method="POST" action="{{ route('academy-admin.questions.update', $question) }}">
                    ...
                    <div class="form-row">
                                <div class="col mb-3" style="font-weight: 700;">
                    ...
                    <div class="form-row ml-1">
                     <b>@lang('site::academy.question.answers')</b>
                     </div>
                     <div class="form-row ml-1">
                     <span class="text-success">Галкой отметьте правильный ответ</span>
                     </div>
