...
@section('content')
    <div class="container">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">@lang('site::messages.add') @lang('site::academy.video.add')</li>
        </ol>
        @alert()@endalert
        ...
        <div class="card mb-5">
            <div class="card-body">
                ...
                <form id="form" method="POST" action="{{ route('academy-admin.videos.store') }}">
                    @csrf
                    <div class="form-row">
                                <div class="col mb-3">
                    ...
                    <div class="form-row">
                                <div class="col mb-3">
                                    ...
                                    <input type="text" name="video[link]"
                                           ...
                                           value="{{ old('video[link]','https://www.youtube.com/embed/') }}"
