...
@section('body')
    ...
    <p>  <dt class="col-sm-3 text-left text-sm-right">@lang('site::admin.mission.status')</dt>
                    ...
                    <dt class="col-sm-3 text-left text-sm-right">@lang('site::messages.date')</dt>
                    <dd class="col-sm-9">c {{$mission->date_from->format('Y-m-d')}}, по {{$mission->date_to->format('Y-m-d')}}</dd>
                    
                    
                    <dt class="col-sm-3 text-left text-sm-right">@lang('site::address.locality')</dt>
                    <dd class="col-sm-9">@if(!empty($mission->region)){{$mission->region->name}}@endif, {{!empty($mission->locality) ? $mission->locality : 'не указан'}}</dd>
                    ...
                    <dd class="col-sm-9">{{$mission->result}}</dd>
                    ...
                    <dd class="col-sm-9">{{$mission->project ? $mission->project->name : 'не задан'}}</dd></p>
