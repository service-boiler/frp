        ...
        @endif
                    <div class="card mb-2">
                        <div class="card-body">
                            ...
                            <form id="form"
                                  method="POST"
                                  action="{{ route('esb-contract-types.store') }}">
                                @csrf
                                        ...
                                        <div class="col mb-3">
                                            ...
                                            <div class="custom-control custom-radio">
                                                <input type="radio"
                                                       ...
                                                       @if(old('enabled') == 1) checked @endif
                                                       value="1"
                                            ...
                                            <div class="custom-control custom-radio">
                                                <input type="radio"
                                                       ...
                                                       @if(old('enabled') == 0) checked @endif
                                                       value="0"
                                                       class="custom-control-input {{$errors->has('enabled') ? ' is-invalid' : ''}}">
                                                <label class="custom-control-label"
