<div class="form-group required" id="form-group-engineer_id">
    <label class="control-label" for="engineer_id">@lang('site::mounting.engineer_id')</label>
    <select data-form-action="{{ route('engineers.create') }}"
            ...
            <option value="">@lang('site::mounting.default.engineer_id')</option>
            @foreach($engineers as $engineer)
                <option @if(old('engineer_id', isset($mounting) ? $mounting->engineer_id : null) == $engineer->id) selected @endif
